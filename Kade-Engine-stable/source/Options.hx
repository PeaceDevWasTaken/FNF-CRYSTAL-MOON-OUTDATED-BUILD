...
class PerfectOption extends Option
{
...
class DaBabyOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		if (dababy > 4){
			...
			{
				FlxG.sound.play(Paths.music('lesssgooo', 'weekmidna'));
				dababy++;
			}
		display = updateDisplay();
		return true;
	...
	private override function updateDisplay():String
		{
			return FlxG.save.data.perfect ? "DABABY" : "DABABY";
		}
}

class SecretOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		...
		FlxG.sound.play(Paths.music('lmao', 'weekmidna'));
		display = updateDisplay();
		return true;
	}
