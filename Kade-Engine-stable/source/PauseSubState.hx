		...
		if (accepted)
		{
			...
			switch (daSelected)
			{
				...
				case "Practice Mode Off":
					...
					PlayState.isValidScore = false; //makes sure that u dont cheat by using practice mode and then turning it off at the end
					trace("practice mode is on");
				case "Skip Song":
				...
				case "Normal":
					...
					PlayState.SONG = Song.loadFromJson(StringTools.replace(PlayState.storyPlaylist[0]," ", "-").toLowerCase() + '-normal', StringTools.replace(PlayState.storyPlaylist[0]," ", "-").toLowerCase());
					FlxG.resetState();
				case "Hard":
				...
				case "Bleeding Edge":
					...
					PlayState.SONG = Song.loadFromJson(StringTools.replace(PlayState.storyPlaylist[0]," ", "-").toLowerCase() + '-bleeding', StringTools.replace(PlayState.storyPlaylist[0]," ", "-").toLowerCase());
					FlxG.resetState();
				case "Exit to menu":
